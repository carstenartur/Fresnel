...
[![Tests](https://img.shields.io/endpoint?url=https://carstenartur.github.io/Fresnel/tests/badge.json)](https://carstenartur.github.io/Fresnel/tests/)
[![Coverage](https://img.shields.io/endpoint?url=https://carstenartur.github.io/Fresnel/coverage/badge.json)](https://carstenartur.github.io/Fresnel/coverage/)
...
📊 **[Coverage report](https://carstenartur.github.io/Fresnel/coverage/)** — JaCoCo HTML and badge JSON, regenerated on every push to `main` and daily.
📋 **[Test report](https://carstenartur.github.io/Fresnel/tests/)** — Surefire summary and badge JSON, regenerated on every push to `main`.

## Test Reports

| Where | What |
|-------|------|
| **Published badge pages** | The *Tests* and *Coverage* workflows publish Shields-compatible `badge.json` files and small HTML summary pages to GitHub Pages. |
...
optical concepts behind Fresnel without turning the README into a long link
collection.

| Resource | Area |
|----------|------|
| [Zone plate](https://en.wikipedia.org/wiki/Zone_plate) | Fresnel zone plates and diffraction focusing |
| [Diffractive optics](https://en.wikipedia.org/wiki/Diffractive_optics) | General diffractive-optics background |
| [Computer-generated holography](https://en.wikipedia.org/wiki/Computer-generated_holography) | CGH concepts and applications |
| [Gerchberg–Saxton algorithm](https://en.wikipedia.org/wiki/Gerchberg%E2%80%93Saxton_algorithm) | Iterative phase-retrieval method used for hologram synthesis |
| [Ansys Zemax OpticStudio](https://www.zemax.com) | Commercial optical design software |
| [Synopsys CODE V](https://www.synopsys.com/optical-solutions/codev.html) | Professional optical simulation and design |

## Why Fresnel?

Fresnel is not just a single zone-plate generator. It combines several printable
and web-accessible diffractive-optics workflows in one open-source application.
