 ...
 * @param wavelengthNm illumination wavelength in nanometres; if {@code null},
 *                     the wavelength from {@code base} is used
...
public record PropagateRequest(
    ...
    public double resolvedWavelengthNm() {
        return (wavelengthNm != null && wavelengthNm > 0) ? wavelengthNm : base().wavelengthNm();
    }
